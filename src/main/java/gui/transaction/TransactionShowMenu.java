...
public class TransactionShowMenu extends BasicMenu {
    ...
    public void showMenu() {
        ...
        System.out.println("8. Show all transactions for the selected banks (Primary and Secondary)");
        System.out.println("9. Show all transactions for the selected types");
        System.out.println("10. Show all transactions for the selected notes");
        System.out.println("11. Show all transactions for the selected name");
        System.out.println("12. Show all transactions for the selected locations");
        System.out.println("13. Show all transactions for the tuned amount in USD " +
